...
### Maybe you're looking for this? 👉[How to update Agent Flux](#how-to-update-agent-flux)
...
- Go to "Images" tab and remove the `fluxframeworks/agent-flux-run` image
...
3. **Full Binaries**
- Using Git/GitHub: Pull the latest version of the Agent Flux repository with. The custom knowledge, solutions, memory, and other data will get ignored, so you don't need to worry about losing any of your custom data. The same goes for your .env file with all of your API keys and settings.json.
