...
> [!IMPORTANT]
>
>**Changes to fluxframeworks/agent-flux Docker image since v0.7:**
>
> The new Docker image `fluxframeworks/agent-flux-run` provides the new unified environment.
...
- [Join our Discord](https://discord.gg/B8KZKNsPpj) for live discussions or [visit our Skool Community](https://www.skool.com/agent-flux).
- [Follow our YouTube channel](https://www.youtube.com/@AgentFluxFW) for hands-on explanations and tutorials
- [Report Issues](https://github.com/fluxframeworks/agent-flux/issues) for bug fixes and features
