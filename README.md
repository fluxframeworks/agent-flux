...
A detailed setup guide with a video can be found here: [/docs/installation](https://github.com/fluxframeworks/agent-flux/tree/main/docs/installation). Scroll down to see the readme file.
