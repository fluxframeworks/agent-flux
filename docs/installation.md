...
> socket to be used (requires password)."  This allows Agent Flux to communicate 
...
> are run. If you want to run Agent Flux on another machine, you will need to run 
